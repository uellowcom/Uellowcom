...
class AiConfig(models.TransientModel):
    ...
    def default_get(self, fields_list):
        ...
        mapping = {
            ...
            'ai_daily_cost_limit':       ('daily_cost_limit',       10.0),
            'ai_price_in':               ('price_in_per_mtok',      3.0),
            'ai_price_out':              ('price_out_per_mtok',     15.0),
            'ai_prompt_cache_enabled':   ('prompt_cache_enabled',   True),
            'ai_cache_enabled':          ('cache_enabled',          False),
            'ai_cache_similarity':       ('cache_similarity',       100),
            'ai_routing_enabled':        ('routing_enabled',        False),
            'ai_archive_enabled':        ('archive_enabled',        True),
            'ai_archive_retention_days': ('archive_retention_days', 90),
            'ai_history_limit':          ('history_limit',          8),
            'ai_generic_keywords':       ('generic_keywords',       ''),
            'ai_search_translations':    ('search_translations',    ''),
            'ai_variable_keywords':      ('variable_keywords',      ''),
