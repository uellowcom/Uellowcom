# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'views/sale_order_filters_views.xml',
    ...
    'assets': {
        ...
        'web.assets_backend': [
            ...
            'delivery_carrier_portal/static/src/js/dashboard_owl.js',
            'delivery_carrier_portal/static/src/xml/dashboard.xml',
            'delivery_carrier_portal/static/src/js/finance_owl.js',
            'delivery_carrier_portal/static/src/xml/finance.xml',
        ],
    },
    'application': False,
    'installable': True,
