...
def migrate(cr, version):
    ...
    # Remove assets
    paths = [
        'uellow_theme_common/static/src/js/components/*.xml',
        'uellow_theme_common/static/src/js/product_template_attribute_line.js',
        'uellow_theme_common/static/src/js/product_template_attribute_line.xml',
        'uellow_theme_common/static/src/js/components/*.js',
        'uellow_theme_common/static/src/js/components/*.scss',
        'uellow_theme_common/static/src/js/navbar/*.js',
        'uellow_theme_common/static/src/js/components/notification/*',
