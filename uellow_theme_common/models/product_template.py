...
class ProductTemplate(models.Model):
    ...
    def _get_combination_info(self, combination=False, product_id=False, add_qty=1.0, parent_combination=False, only_template=False):
        ...
        website = self.env['website'].get_current_website()
        website_has_uellow_theme = website._dr_website_has_uellow_theme()
        if website and website_has_uellow_theme:
            ...
            if combination_info['product_id']:
                ...
                combination_info['tp_extra_fields'] = IrUiView._render_template('uellow_theme.product_extra_fields', values={'website': website, 'product_variant': product_variant_id, 'product': product_variant_id.product_tmpl_id})
