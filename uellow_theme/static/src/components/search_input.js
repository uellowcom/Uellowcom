...
export class TpDropDown extends Component {
    ...
    get buttonPlaceholder() { return this.props.buttonPlaceholder || 'uellow_theme.tp_dropdown_placeholder'; }
    get dropDownPlaceholder() { return this.props.dropDownPlaceholder || 'uellow_theme.tp_dropdown_placeholder'; }
    get menuClass() { return this.props.menuClass || ''; }
    get menuItemClass() { return this.props.menuItemClass || ''; }
}
TpDropDown.template = 'uellow_theme.TpDropDown';
...
export class TpSearchInput extends CoreComponent {
    ...
    get resModelInfo() {
        return {
        'product.template': { title: _t("Products"), template: 'uellow_theme.tpProductPlaceHolder'},
        'product.product': { title: _t("Variants"), template: 'uellow_theme.tpProductPlaceHolder'},
        'product.public.category': { title: _t("Categories"), template: 'uellow_theme.tpProductPlaceHolder'},
...
TpSearchInput.template = 'uellow_theme.TpSearchInput';
...
TpRangeInput.template = 'uellow_theme.TpRangeInput';
...
TpBoolean.template = 'uellow_theme.TpBoolean';
...
TpImageUpload.template = 'uellow_theme.TpImageUpload';
...
export class TpCardGrid extends AbstractComponent {
    ...
    async updateData(IDs) {
        ...
        let fetchedCategoryData = await this.componentService._fetchRecords({ options: { getCount: true, categoryIDs: recordsIDs }, fields: ['dr_category_label_id'] }, { routePath: '/uellow_theme/get_categories_info' });
        let records = [];
    ...
    get styles() {
        return Object.keys(registry.category('uellow_theme_mega_menu_cards').content);
    }
...
TpCardGrid.template = 'uellow_theme.TpCardGrid';
...
export class TpComponentGroup extends AbstractComponent {
    ...
    get mobileStyles() {
        let headerRegistry = registry.category('uellow_theme_mobile_card_registry');
...
TpComponentGroup.template = 'uellow_theme.TpComponentGroup';
...
export class TpActions extends Component {
    setup() {
        ...
        if(!this.isReadOnly) {
            ...
            onWillStart(async () => {
                this.shopConfig = await this.orm.call("website", "get_uellow_theme_shop_config", [], {context: {website_id: this.website.currentWebsite.id}});
            });
        }
    }
    ...
    _getAction(action) {
        let allActions = { colors: { icon: 'uellow_theme.icon_brush', label: _t('Colors') }, count: { icon: 'uellow_theme.icon_hash_tag', label: _t("Count") }, brand: { icon: 'uellow_theme.icon_tag', label: _t("Brands") }, quick_view: { icon: 'uellow_theme.icon_eye', label: _t('QUICK VIEW') }, add_to_cart: { icon: 'uellow_theme.icon_cart', label: _t('ADD TO CART') }, category_info: { icon: 'uellow_theme.icon_font', label: _t('CATEGORY') }, wishlist: { icon: 'uellow_theme.icon_heart', label: _t('WISHLIST') }, comparison: { icon: 'uellow_theme.icon_exchange', label: _t('COMPARE') }, rating: { icon: 'uellow_theme.icon_star', label: _t('RATING') }, description_ecommerce: { icon: 'uellow_theme.icon_description', label: _t('DESCRIPTION') }, label: { icon: 'uellow_theme.icon_tag', label: _t('LABEL') }, show_similar: { icon: 'uellow_theme.icon_box', label: _t('SIMILAR') } };
...
TpActions.template = 'uellow_theme.TpActions';
...
TpDatePicker.template = 'uellow_theme.TpDatePicker';
...
TpDomainComponent.template = 'uellow_theme.TpDomainComponent';
