...
export class TpUiComponent extends AbstractComponent {
    ...
    get headers() {
        let headerRegistry = registry.category('uellow_theme_product_list_cards_headers');
...
TpUiComponent.template = 'uellow_theme.TpUiComponent';
...
export class TpExtraOpts extends AbstractComponent {
    ...
    get allPricelistDropdown() {
        ...
        return { ...buttonClasses, value: this?.componentDefaultVal?.priceList || '*', dropDownPlaceholder: 'uellow_theme.tp_pricelist_dropdown_placeholder', name: "priceList", records: [...this.pricelists]};
    }
    get nodeOptions() {
...
TpExtraOpts.template = 'uellow_theme.TpExtraOpts';