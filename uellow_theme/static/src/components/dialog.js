...
import { useCore } from '@uellow_theme_common/js/hooks';
...
export class TpSnippetConfigDialog extends Component {
    ...
    get allSnippptsDropdown() {
        let buttonClasses = { menuClass: 'row ps-2 pe-0 g-0 tp-snippet-dropdown', menuItemClass: 'col-6 pe-2 position-relative', dropDownPlaceholder: 'uellow_theme.tp_snippet_dropdown_placeholder', buttonClasses: "btn d-flex justify-content-between align-items-center btn-light shadow-sm tp-rounded-border-lg fw-light w-100 mx-auto pe-2 p-0" };
    ...
    get allPricelistDropdown() {
        ...
        return { props: { ...buttonClasses, dropDownPlaceholder: 'uellow_theme.tp_pricelist_dropdown_placeholder', name: "activePricelist", value: this.previewState.activePricelist, records: this.pricelists}, component: Components.TpDropDown.Component };
    }
    ...
    get templateIDs(){
        ...
        Object.keys(SnippetRegistry.content).forEach(function (snippetID) {
            let prefix = snippetID.includes('mega_menu') ? 'uellow_theme_common.' : 'uellow_theme.';
...
TpSnippetConfigDialog.template = 'uellow_theme.snippetConfigDialog';
