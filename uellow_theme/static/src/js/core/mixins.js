...
import { CartConfirmationDialog } from "@uellow_theme/js/dialog/cart_confirmation_dialog";
import { QuickViewDialog } from "@uellow_theme/js/dialog/quick_view_dialog";
import wSaleUtils from "@website_sale/js/website_sale_utils";
import { loadJS } from "@web/core/assets";
import { rpc } from "@web/core/network/rpc";
import { CartSidebar } from "@uellow_theme/js/sidebar/sidebar";
...
export let B2bMixin = {
    ...
    _loggedInNotification: function () {
        ...
        this.displayNotification({
            ...
            templateToUse: 'uellow_theme.NotificationGeneric',
...
export let OwlMixin = {
    extraLibs: ['/uellow_theme/static/lib/OwlCarousel2-2.3.4/owl.carousel.js'],
...
export const CartManagerMixin = Object.assign({}, B2bMixin, {
    ...
    _outOfStockNotification: function (data) {
        this.displayNotification({
            ...
            templateToUse: 'uellow_theme.NotificationGeneric',
            message: markup(renderToString('DroggolNotification', { subIconClass: 'fa fa-exclamation-circle', color: 'danger', productID: data.product_id, productName: _t('Currently not in stock.'), message: _t('Check again later.')})),
