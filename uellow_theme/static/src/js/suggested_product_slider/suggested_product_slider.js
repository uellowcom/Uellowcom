...
import { ProductsBlockMixins } from "@uellow_theme/js/core/mixins";
...
publicWidget.registry.TpSuggestedProductSlider = ProductRootWidget.extend(ProductsBlockMixins, {
    ...
    jsLibs: (ProductRootWidget.prototype.jsLibs || []).concat(['/uellow_theme/static/lib/OwlCarousel2-2.3.4/owl.carousel.js']),
