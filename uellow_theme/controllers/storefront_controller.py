# -*- coding: utf-8 -*-
"""
Uellow storefront JSON-RPC endpoints.

Consolidated from `product_page_custom` so the theme is self-contained
once that module is uninstalled during the theme migration. Route paths
stay under `/ppc/` for now to keep the existing JS in the theme working
without churn — they can be renamed in a later, isolated pass.
"""
from odoo import http
from odoo.http import request


class UellowStorefrontController(http.Controller):
