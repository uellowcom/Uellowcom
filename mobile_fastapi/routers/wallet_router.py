...
async def get_wallet(
    ...
    try:
        ...
        if 'loyalty.card' in env:
            ...
            loyalty_cards = env['loyalty.card'].sudo().search([('partner_id', '=', partner_id)])
        ...
        if 'account.move.line' in env:
            ...
            for line in move_lines:
                ...
                transactions.append({
                    ...
                    'status': 'posted' if line.move_id.state == 'posted' else 'draft'
                })
...
async def redeem_points(
    ...
    try:
        ...
        if 'loyalty.card' not in env:
            return {
                'success': False,
                'error': 'Loyalty program not available'
            }
        ...
        reward = env['loyalty.reward'].sudo().search(
        ...
        if not reward:
            return {
                'success': False,
                'error': 'No rewards available in this program'
            }
...
async def get_wallet_transactions(
    ...
    try:
        ...
        if 'loyalty.point' in env:
            ...
            loyalty_points = env['loyalty.point'].sudo().search(
                [('partner_id', '=', partner_id)],
