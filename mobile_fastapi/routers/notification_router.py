...
async def get_notifications(
    ...
    try:
        ...
        notifications_records = (
            env["mail.notification"]
            .sudo()
            .search(domain, limit=limit, offset=offset, order="date desc")
        )
...
async def mark_notification_read(
    ...
    try:
        ...
        notification = (
            env["mail.notification"]
            .sudo()
            .search([("id", "=", notification_id), ("res_partner_id", "=", partner_id)])
        )
...
async def mark_all_notifications_read(
    ...
    try:
        ...
        notifications = (
            env["mail.notification"]
            .sudo()
            .search([("res_partner_id", "=", partner_id), ("is_read", "=", False)])
        )
        ...
        return {
            "success": True,
            "data": {"message": f"{len(notifications)} notifications marked as read"},
        }
    except Exception as e:
        return {"success": False, "error": str(e)}
...
async def register_device(
    ...
    try:
        ...
        if "mobile.device" not in env:
            return {"success": False, "error": "Device registration not available"}
...
async def unregister_device(
    ...
    try:
        ...
        device.sudo().write({"is_active": False})
