# -*- coding: utf-8 -*-
{
    ...
    "data": [
        "security/security_groups.xml",  # Create users and groups FIRST
        "security/ir.model.access.csv",  # Then load access rights (references groups)
        "data/fastapi_endpoint.xml",  # Then create endpoints
