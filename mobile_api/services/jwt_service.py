...
class JWTService:
    ...
    def _load_config(self, env):
        ...
        self.secret_key = config.get_param(
            "mobile_api.jwt.secret_key", "your-secret-key-change-in-production"
        )
        self.algorithm = config.get_param("mobile_api.jwt.algorithm", "HS256")
        self.access_token_expire_minutes = int(
            config.get_param("mobile_api.jwt.access_token_expire_minutes", "30")
        )
        self.refresh_token_expire_days = int(
            config.get_param("mobile_api.jwt.refresh_token_expire_days", "7")
        )
    ...
    def create_access_token(
        self, user_id: int, email: str = None, additional_claims: Dict = None
    ) -> str:
    ...
    def create_tokens(
        self, user_id: int, email: str, additional_claims: Dict = None
    ) -> Dict[str, Any]:
