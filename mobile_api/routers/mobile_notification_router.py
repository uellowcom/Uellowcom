...
async def mark_notification_read(
    ...
    try:
        ...
        notification.read_date = env['mobile.notification']._fields['read_date'].default()
...
async def send_test_notification(
    ...
    try:
        ...
        success = await firebase_messaging.send_notification(
            token=current_user.mobile_notification_token,
            title="Test Notification",
            body="This is a test notification from Yellow Mobile API",
            data={
                "type": "test",
                "timestamp": str(env['mobile.notification']._fields['create_date'].default())
            }
        )
