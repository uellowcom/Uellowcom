...
class _WalletDetailState extends State<WalletDetail> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      context.read<WalletProvider>().fetchBalance(context);
      context.read<WalletProvider>().fetchTransaction(context);
      context.read<WalletProvider>().webViewWallet('topup', context);
      context.read<WalletProvider>().webViewWallet('transfer', context);
    });
  }
