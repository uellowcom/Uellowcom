...
stringToCurrency(num idr, context) {
  ...
  decimalNumber = generalCurrency.selectedCurrency!.decimals!;
  ...
  // if (currencySetting.currency.position != null) {
...
shippingCurrency(num idr, context) {
  final currencySetting = Provider.of<HomeProvider>(context, listen: false);
  ...
  final convertedPrice = Money.fromNum(idr, isoCode: code!);
  return convertedPrice.toString();
}
